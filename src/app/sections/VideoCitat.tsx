...
const VideoCitat = () => {
  return (
    <section className='w-full 2xl:mt-14 xl:mt-10 lg:mt-6 mt-2'>
      <div className='relative w-full h-full bg-overlayVideoCitat  flex items-center justify-center'>
        <div className='max-w-max-container my-0 mx-auto relative lg:py-24 py-16'>

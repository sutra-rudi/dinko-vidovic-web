...
const BannerSekcija = () => {
  ...
  //       // fill
  //       className='block w-full relative 2xl:h-[961px] lg:h-[450px] h-[400px] xl:aspect-square aspect-video object-center object-cover'
  //       placeholder='blur'
  //     />
  //     // </div>
  //   ),
  ...
  return (
    <section className='2xl:mt-24 xl:mt-20 lg:mt-16 mt-12'>
      {/* <ParallaxBanner className='w-full h-full h-[961px]' layers={[background, foreground]} /> */}
